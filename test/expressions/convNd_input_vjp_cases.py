"""Test cases for ``einconv.expressions.convNd_input_vjp``"""
...
INPUT_VJP_1D_IDS = [make_id(case) for case in INPUT_VJP_1D_CASES]
...
INPUT_VJP_2D_IDS = [make_id(case) for case in INPUT_VJP_2D_CASES]
...
INPUT_VJP_3D_IDS = [make_id(case) for case in INPUT_VJP_3D_CASES]
